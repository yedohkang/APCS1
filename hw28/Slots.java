...
public class Slots {
    ...
    public void spinOnce () {
		for (int x = 0; x < _fruits.length; x+=1) {
			// swaps with a random index
		    int indexSwap = (int) (Math.random() * _fruits.length); 
		    swap (x,indexSwap);
		}
    }
    ...
    public boolean miniWin() {		
		if ((jackpot() == true) || ((_fruits[0].equals(_fruits[1]) == false) && (_fruits[1].equals(_fruits[2]) == false))) {
			return true;
		}
		else {
			return false;
